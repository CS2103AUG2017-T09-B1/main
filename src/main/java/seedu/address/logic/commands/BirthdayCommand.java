...
public class BirthdayCommand extends UndoableCommand {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds the birthday of the person identified "
    ...
    public static final String COMMAND_EXAMPLE = COMMAND_WORD + " 1 " + PREFIX_BIRTHDAY + "20/11/1995";
